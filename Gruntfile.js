  ...
  grunt.initConfig({
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'sphinx_shoop_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'sphinx_shoop_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["sphinx_shoop_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['sphinx_shoop_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
